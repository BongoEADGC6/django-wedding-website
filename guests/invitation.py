...
def get_invitation_context(party):
    return {
        ...
        'main_color': '#fff3e8',
        'font_color': '#666666',
        'page_title': "Cliff and Melissa - You're Invited!",
...
def send_invitation_email(party, test_only=False, recipients=None):
    ...
    template_text = "You're invited to Cliff and Melissa's wedding. To view this invitation, visit {} in any browser.".format(
